                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            <div class="d-flex mb-2">
                                <h6 class="fs-14 mb-0 flex-grow-1 text-truncate"><a href="{{URL::asset('/apps-tasks-details')}}"
                                        class="text-body">Profile Page
                                        Structure</a></h6>
                                <div class="dropdown">
                ...
                <div id="todo-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            <div class="d-flex mb-2">
                                <div class="flex-grow-1">
                                    <h6 class="fs-14 mb-0 text-truncate"><a href="{{URL::asset('/apps-tasks-details')}}"
                                            class="text-body">Admin
                                            Layout Design</a></h6>
                                </div>
                                <div class="flex-shrink-0">
                ...
                <div id="inprogress-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-14 text-truncate"><a href="{{URL::asset('/apps-tasks-details')}}" class="text-body">Brand
                                    Logo Design</a></h6>
                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-14 text-truncate"><a href="{{URL::asset('/apps-tasks-details')}}"
