    ...
    @section('content')
        ...
        <div class="layout-wrapper landing">
            <nav class="navbar navbar-expand-lg navbar-landing fixed-top" id="navbar">
                <div class="container">
                    <a class="navbar-brand" href="{{URL::asset('/landing')}}">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8 col-sm-10">
                            <div class="text-center mt-lg-5 pt-5">
                                <h1 class="display-6 fw-bold mb-3 lh-base">If a door closes, <span
                                        class="text-success">Abbrri </span> tu Negocio!</h1>
                                <p class="lead text-muted lh-base">Abbrri is an E-commerce Zamboanga-based startup that supports Micro, Small and Medium Enterprises to bring their business online.</p>

                                <div class="d-flex gap-2 justify-content-center mt-4">
                                    <a href="{{URL::asset('/auth-signup-basic')}}" class="btn btn-primary">Get Started <i
                                            class="ri-arrow-right-line align-middle ms-1"></i></a>
                                    <a href="{{URL::asset('/apps-ecommerce-sellers')}}" class="btn btn-danger">View Shops <i
