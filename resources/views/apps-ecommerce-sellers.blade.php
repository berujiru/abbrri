        ...
        <div class="col-xl-3 col-lg-6">
            <div class="card ribbon-box right overflow-hidden">
                <div class="card-body text-center p-4">
                    ...
                    <h5 class="mb-1 mt-4"><a href="{{URL::asset('/apps-ecommerce-seller-details-custom')}}" class="link-primary">Force
                            Medicines</a></h5>
                    ...
                    <div class="mt-4">
                        <a href="{{URL::asset('/apps-ecommerce-seller-details-custom')}}" class="btn btn-light w-100">View Details</a>
                    </div>
                </div>
            </div>
        </div>
