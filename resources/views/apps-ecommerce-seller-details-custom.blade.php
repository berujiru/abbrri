...
@section('content')
    ...
    <div class="row">
        <div class="col-xxl-3">
                ...
                <div class="card-body p-4">
                    <div>
                        ...
                        <div class="mt-4 text-center">
                            <h5 class="mb-1">   <a href="">  Force Medicines</a></h5>
                            <p class="text-muted">View Landing Page</p>
                        </div>
            ...
            <!--end card-->
            <div class="team-list grid-view-filter">
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-header border-0 align-items-center d-flex">
                    <h5 class="card-title mb-0 flex-grow-1">Welcome!</h5>
                        <div class="flex-shrink-0">
                        <button type="button" id="copylink" class="btn btn-outline-info btn-icon waves-effect waves-light"><i class="ri-stackshare-line"></i></button>
                        </div>
                </div><!-- end card header -->
            ...
            <div class="row">
                <div class="justify-content-between d-flex align-items-center mt-3 mb-4">
                    <h5 class="mb-0 pb-1 text-decoration-underline">Products</h5>
                </div>
                <div class="col-sm-6 col-xl-3">
                    <div class="card">
                        <a href="apps-ecommerce-product-details"><img class="card-img-top img-fluid" src="{{ URL::asset('assets/images/products/img-1.png') }}" alt="Card image cap"></a>
                        <div class="card-body">
...
@section('script')
    ...
    <script src="{{ URL::asset('/assets/js/pages/shop-details.init.js') }}"></script>
